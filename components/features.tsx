      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">500+ business partners</h2>
            <p className="text-xl text-gray-400">
              {" "}
              We serve as the exclusive distributor in South Korea for U.S.
              publicly listed companies such as Natus Medical, Clarity Medical,
              Clinical Innovations, and others.
            </p>
          </div>
